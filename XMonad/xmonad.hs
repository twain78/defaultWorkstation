--  example config file for xmonad-0.9
--
...
--
-- myWorkspaces	  = [ "code", "system",  "web-work", "web-fun", "mail", "music"]
myWorkspaces    = ["1:code","2:system","3:web-work","4:web-fun","5:mail","6:music"] ++ map show [6..9]
...
--- TODO Create Shortcuts for '+' and '-' to zoom in/out in ScreenBuffer(or something similar) 
    
    -- launch a terminal
    [ ((modm .|. shiftMask, xK_Return), spawn $ XMonad.terminal conf)
 
    -- launch desktop on win + q
    ...
    -- this block automatically adapts to my current keyboard-layout 
    --
...
myManageHook = composeAll $
    ...
    , className =? "Google-chrome"  --> doShift "3:web-work"
